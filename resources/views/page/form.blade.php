<form action="{{ $form['url'] }}" method="post" class="form-horizontal">
    ...
    <div class="form-group{!! ($errors->has('title')) ? ' has-error' : '' !!}">
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
            <input name="title" id="title" value="{!! old('title', $form['defaults']['title']) !!}" type="text" class="form-control" placeholder="Page Title">
    ...
    <div class="form-group{!! ($errors->has('slug')) ? ' has-error' : '' !!}">
        ...
        <div class="col-lg-3 col-md-4 col-sm-5 col-xs-10">
            <input name="slug" id="slug" value="{!! old('slug', $form['defaults']['slug']) !!}" type="text" class="form-control" placeholder="Page Slug">
    ...
    <div class="form-group{!! ($errors->has('content')) ? ' has-error' : '' !!}">
        ...
        <div class="col-lg-6 col-md-8 col-sm-9 col-xs-12">
            <textarea name="content" id="content" class="form-control" placeholder="Page content" rows="8">{!! old('content', $form['defaults']['content']) !!}</textarea>
